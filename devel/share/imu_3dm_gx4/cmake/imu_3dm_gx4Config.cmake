...
if("TRUE" STREQUAL "TRUE")
  set(imu_3dm_gx4_SOURCE_PREFIX /home/fnaser/catkin_ws/src/imu_3dm_gx4-master)
  set(imu_3dm_gx4_DEVEL_PREFIX /home/fnaser/catkin_ws/devel)
  ...
  set(imu_3dm_gx4_INSTALL_PREFIX /home/fnaser/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fnaser/catkin_ws/src/imu_3dm_gx4-master/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
    endif()
...
set(imu_3dm_gx4_EXPORTED_TARGETS "imu_3dm_gx4_generate_messages_cpp;imu_3dm_gx4_generate_messages_lisp;imu_3dm_gx4_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${imu_3dm_gx4_dep}_FOUND)
      find_package(${imu_3dm_gx4_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${imu_3dm_gx4_dep} REQUIRED ${depend_list})
  endif()
